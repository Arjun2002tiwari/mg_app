    ...
    return Scaffold(
      appBar: AppBar(
        ...
        color: Color.fromARGB(255, 213, 122, 117),
                ...
                subtitle: Text('Security notificatuins change number',style: TextStyle(color: Color.fromARGB(255, 181, 154, 154))),
                onTap: () {
              ...
              ListTile(
                ...
                subtitle: Text("Block contacts disappearing messages",style: TextStyle(color: Color.fromARGB(255, 181, 154, 154))),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                subtitle: Text("Theme,Wallpapers,chat history",style: TextStyle(color: Color.fromARGB(255, 181, 154, 154))),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                subtitle: Text("Message,group  & call tones",style: TextStyle(color: Color.fromARGB(255, 181, 154, 154)),),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                subtitle: Text("English",style: TextStyle(color: Color.fromARGB(255, 181, 154, 154)),),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
               ListTile(
                ...
                subtitle: Text("Help center,contact us,privacy policy",style: TextStyle(color: Color.fromARGB(255, 181, 154, 154)),),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
        ...
        return ListView.builder(
          ...
          image:DecorationImage(
            ...
            child: ListTile(
              ...
              title:Text(x['username'],style: TextStyle(fontSize: 25,color: Color.fromARGB(255, 249, 247, 247)),),
              subtitle: Text(x['email'],style:TextStyle(fontSize:15,color:Color.fromARGB(255, 255, 254, 254))),
               leading:Container(child: Stack(children: [
                 CircleAvatar(
                  radius: 23,
                  child:Icon(Icons.person,color: Color.fromARGB(255, 37, 36, 36),),
